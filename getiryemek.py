...
class ToggleSwitch(QWidget):
    ...
    def paintEvent(self, event):
        ...
        if self._checked:
            painter.setBrush(QColor("#57007f"))
        else:
...
class GetirYemekPage(QWidget):
    def __init__(self, parent=None):
        ...
        painter.fillRect(mor_pixmap.rect(), QColor("#57007f"))
        painter.end()
        ...
        pixmap = QPixmap("getir.png").scaled(30, 30, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        logo_label.setPixmap(pixmap)
        logo_label.setStyleSheet("background-color: transparent;")

        getiryemek_label = QLabel("GetirYemek")
        ...
        hazirlaniyor_label = QLabel("Hazırlanıyor")
    ...
    def update_progress_bar(self, order_data):
        ...
        for index, (step_name, icon_path, active, time_text) in enumerate(steps):
            ...
            icon_label.setStyleSheet(f"background-color: {'#f28b25' if active else '#d3d3d3'}; border-radius: 24px;")
            ...
            if index < len(steps) - 1:
                ...
                progress_line.setStyleSheet(f"background-color: {'#f28b25' if active else '#d3d3d3'}; border: none;")
    ...
    def select_order_card(self, selected_card, order_data):
        ...
        selected_card.setStyleSheet("background-color: #e0d7f5; border-radius: 10px; margin: 10px; padding: 15px 20px;")
